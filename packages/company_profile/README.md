...
任务提交、状态查询和加密回调的完整报文规范见 [service/服务接口与交互规范.md](../../service/company_profile_service/服务接口与交互规范.md)。
...
完整变量列表见 [.env.example](../../service/company_profile_service/.env.example)。
